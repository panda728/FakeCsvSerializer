...
internal class BuiltinSerializers
{
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, string? value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, Guid value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, Enum value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, DateTimeOffset value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, TimeSpan value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, Uri value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, DateOnly value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
    ...
    {
        public void WriteTitle(ref CsvSerializerWriter writer, TimeOnly value, CsvSerializerOptions options, string name = "")
            => writer.Write(name);
